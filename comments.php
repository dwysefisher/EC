...
<section id="respond" class="respond-form">
	...
	<h3 id="comment-form-title" class="h2"><?php comment_form_title( __('Leave a Comment', 'bonestheme'), __('Leave a Comment to %s', 'bonestheme' )); ?></h3>
	...
	<?php if ( get_option('comment_registration') && !is_user_logged_in() ) : ?>
		<div class="alert alert-help">
			<p><?php printf( __('You must be %1$slogged in%2$s to post a comment.', 'bonestheme'), '<a href="/wp-login.php?action=register">', '</a>' ); ?></p>
		</div>
	<?php else : ?>
	...
	<p><textarea name="comment" id="comment" placeholder="<?php _e('Your Comment here...', 'bonestheme'); ?>" tabindex="3"></textarea></p>

	<p>
		<input name="submit" type="submit" id="submit" class="button" tabindex="4" value="<?php _e('Submit', 'bonestheme'); ?>" />
