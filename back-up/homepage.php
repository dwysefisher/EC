						...
						<div class="homepage-lower-content">
							...
							<div class="homepage-lower-graphics">
								<div class="homepage-lower-graphics-column-one">
									<a href="/academics/study-abroad/" title="Students Studying Abroad in 21 Countries and 13 States"><img src="<?php echo get_template_directory_uri(); ?>/library/images/stats-btn-study-abroad.png" border="0" alt="Eureka Study Abroad Program" /></a>
								</div>
								<div class="homepage-lower-graphics-column-two">
									<a href="/admissions/scholarships/" title="100% Merit-based Financial Aid"><img src="<?php echo get_template_directory_uri(); ?>/library/images/stats-btn-financial-aid.png" border="0" alt="100% Merit Based Financial Aid"/></a>
								</div>
								<div class="homepage-lower-graphics-column-three">
									<a href="/academics/eureka-academics/" title="13:1 Student-to-Faculty Ratio" title="13:1 Student-to-Faculty Ratio"><img src="<?php echo get_template_directory_uri(); ?>/library/images/stats-btn-student-faculty-ratio.png" border="0" alt="13:1 Student-to-Faculty Ratio" /></a>
								</div>
								<div class="homepage-lower-graphics-column-four">
									<a href="/admissions/letter-of-intent-deposit/" title="Commit to EC"><img src="<?php echo get_template_directory_uri(); ?>/library/images/stats-btn-commit-to-ec.png" border="0"  alt="Commit to EC" /></a> <!-- Icon made by <a href="http://www.freepik.com" title="Freepik">Freepik</a> from <a href="http://www.flaticon.com" title="Flaticon">www.flaticon.com</a> is licensed under <a href="http://creativecommons.org/licenses/by/3.0/" title="Creative Commons BY 3.0">CC BY 3.0</a> -->
								</div>
							</div>
						</div>
