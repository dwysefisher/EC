...
<!--[if gt IE 8]><!--> <html <?php language_attributes(); ?> class="no-js"><!--<![endif]-->
	...
	<head>
		...
		<link rel="pingback" href="<?php bloginfo('pingback_url'); ?>">
		 ...
		 <!--[if gt IE 9]>
			<script type="text/javascript" src="<?php echo get_template_directory_uri(); ?>/library/js/libs/css3-mediaqueries.js"></script>
		<![endif]--> 
							...
							<div class="mobile-main-nav-drop-down-content-col-right-inner">
								...
								<div class="mobile-main-nav-students-menu m-hide">
									<ul class="mobile-drop-menu-list">
										...
										<li><a href="https://www.google.com/a/eureka.edu/ServiceLogin?service=mail&passive=true&rm=false&continue=https://mail.google.com/a/eureka.edu/&ss=1&ltmpl=default&ltmplcache=2" target="_blank" title="Email"><img class="mobile-student-menu-icon" src="<?php echo get_template_directory_uri(); ?>/library/images/mobile-student-menu-email-icon.png" width="24" height="24" />Email</a></li>
									</ul>
								</div>
