							...
							<div class="mobile-main-nav-drop-down-content-col-right-inner">
								...
								<div class="mobile-main-nav-students-menu m-hide">
									<ul class="mobile-drop-menu-list">
										...
										<li><a href="mail.eureka.edu" target="_blank" title="Email"><img class="mobile-student-menu-icon" src="<?php echo get_template_directory_uri(); ?>/library/images/mobile-student-menu-email-icon.png" width="24" height="24" />Email</a></li>
									</ul>
								</div>
