				...
				<div id="home-inner-content" class="wrap clearfix">
						...
						<div class="homepage-mobile-links">
							<div class="homepage-mobile-links-left-column">
								...
								<a class="homepage-mobile-icon-btn" href="/athletics" title="Eureka Athletics"><img src="<?php echo get_template_directory_uri(); ?>/library/images/mobile_Athletics.jpg" border="0" width="200" height="115" alt="Eureka Athletics" /></a>
							...
							<div class="homepage-mobile-links-right-column">
								...
								<a class="homepage-mobile-icon-btn" href="/alumni" title="Eureka Alumni"><img src="<?php echo get_template_directory_uri(); ?>/library/images/mobile_Alumni3.jpg" border="0" width="200" height="115" alt="Eureka Alumni" /></a>
							</div>
						...
						<div id="home-sidebar">
							<div id="home-news-events">
								<div id="home-news-event-header">
									<h3><a href="http://www.eureka.edu/news/" style="color:#fff;">News</a> and <a href="http://www.eureka.edu/events/" style="color:#fff;">Events</a></h3>
								</div>
								<?php
									global $post;
						...
						<div class="homepage-lower-content">
							<div class="homepage-lower-links">
								<div class="homepage-lower-links-column-one">
									<a href="/giving/give-now/" title="Give Now"><img src="<?php echo get_template_directory_uri(); ?>/library/images/give-now-btn.png" border="0" width="278" height="66" alt="Give Now" /></a>
								</div>
								<div class="homepage-lower-links-column-two">
									<a href="/admissions/apply-now/" title="Apply Today"><img src="<?php echo get_template_directory_uri(); ?>/library/images/apply-today-btn.png" border="0" width="278" height="66" alt="Apply Today" /></a>
								</div>
								<div class="homepage-lower-links-column-three">
									<a href="http://reagan.eureka.edu/society/" target="_blank" title="The Reagan Society"><img src="<?php echo get_template_directory_uri(); ?>/library/images/reagan-society-btn.png" border="0" width="278" height="66" alt="The Reagan Society" /></a>
								</div>
							</div>
